...
2. At the bottom of the flight plan window, tap the **share icon** (⬆️ - square with up arrow)
...
2. In the flight planning screen, tap the **share icon** (⬆️ - square with up arrow) at the bottom left
3. Select **"Print Navlog"**
4. Tap the **share icon** (⬆️ - square with up arrow) at the top right
...
2. In the Plans section, tap the **share icon** (⬆️ - square with up arrow) at the top right
3. Select **"PRINT"**
4. Tap the **share icon** (⬆️ - square with up arrow) at the top
5. Choose **"PlanToSim"** from the app list
